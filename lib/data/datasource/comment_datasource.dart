...
abstract class ICommentDatasource {
  ...
  Future<void> postComments(String productId, String comment);
}

class CommentRemoteDatasource extends ICommentDatasource {
  final Dio _dio = locator.get();
  final String userId = AuthManeger.geteId();
  @override
  Future<List<Comment>> getComments(String productId) async {
    try {
      ...
      return response.data['items']
          .map<Comment>((jsonObject) => Comment.fromMapson(jsonObject))
          .toList();
  ...
  @override
  Future<void> postComments(String productId, String comment) async {
    try {
